...
log_dir = "C:/Users\Tiana\Documents\Github\ZB4171_LeukemiaImageClassification-Ongoing-\Results/NoisyStudent/training_results\stats\debug"
...
for file in log_files:
    ...
    with open(filepath, 'r') as log:
        ...
        for line in log.readlines()[105:155]: #only plot first 100 epochs
            # get general info
            info = line.split(',')
            # get epoch info
    ...
    fig.savefig(log_dir + '/student_loop2_fold1_noisy_debug_log' + '.png', bbox_inches="tight")